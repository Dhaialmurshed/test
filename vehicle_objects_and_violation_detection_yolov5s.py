# -*- coding: utf-8 -*-
"""11Feb_FinslTestModel_WithHighTrueCountFormula.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18wX5at4wh9lYEHdeWnaagfbtwSt0zrId
"""
...
# this function to calculate how many high prediction values we have
def countTruePred(Q):
  countTrue = 0
  ...
  if(countTrue >= 4): # if we have 4 high value predictions in a video then it is a violation
    return True
  else:
    return False
  return False
...
def print_results(video, filename, limit=None):
        ...
        while True: # loop till end of the video file
          ...
          if frameCounter == 10: # as per second we have 30 frames and we want to take the 10th frame in each ieteration
            ...
            i = (preds > 0.37)[0] # violance threshold
            label = i
